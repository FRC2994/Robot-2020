...
public class Constants {
    ...
    public static final int CAN_LEFT_BACK_WHEEL      = 4;
     ...
     /**
      * Add to these constants as necessary to define presets
      * for shooter wheel speed settings and hood position settings.
      * Integers were chosen arbitrarily and can be changed to whatever
